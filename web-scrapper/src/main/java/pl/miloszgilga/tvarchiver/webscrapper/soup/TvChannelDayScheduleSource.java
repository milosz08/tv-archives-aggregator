...
public class TvChannelDayScheduleSource extends AbstractUrlSource {
	public TvChannelDayScheduleSource(String channelSlug, LocalDate selectedDay) {
		super(UrlSource.TV_CHANNEL_DAY_SCHEDULE, channelSlug, Constant.DTF.format(selectedDay));
	}
}
